...
<head>
    ...
    <title>Quiero aventura - Carrito de Compras</title>
...
<body class="bg-light">
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4 bg-dark text-white p-3 rounded">            
        <a href="index.php" style="text-decoration: none;">
            <img src="imagenes/logo.jpg" style="max-width: 100px; border: 2px solid white; border-radius: 5px;filter: grayscale(100%);">
        </a>
            <h1 class="mb-0">Su pedido:</h1>
