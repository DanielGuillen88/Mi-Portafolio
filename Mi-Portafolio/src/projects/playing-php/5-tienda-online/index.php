...
<body class="bg-light">
    <div class="container py-4">
        ...
        <a href="index.php" style="text-decoration: none;">
            <img src="imagenes/logo.jpg" style="max-width: 160px; border: 2px solid orange; border-radius: 5px;">
        </a>
            <h1 class="mb-0" style="color: orangered;">🧡 ADVENTURE</h1>
            <a class="btn btn-outline-warning" href="ver_productos.php">Trastienda</a>
        ...
        <div class="category-container">
            ...
            <button class="category-btn" data-category="calzado">👟 Calzados</button>
            <button class="category-btn" data-category="accesorio">🎒 Accesorios</button>
            <button class="category-btn" data-category="tecnologia">💻 Tecnología</button>
            <button class="category-btn" data-category="comida">🥓 Alimentacíon</button>
