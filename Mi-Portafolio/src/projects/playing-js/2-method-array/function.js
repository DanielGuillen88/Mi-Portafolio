...
function checkInserso() {
  ...
  function imserso2() {
    ...
    const widowed = document.querySelector('input[name="widowed"]:checked').value;
    ...
    if (age >= 60 || (age >= 55 && widowed === "si")) {
      alert("Te puedes apuntar al Imserso");
    } else {
      alert("No puedes apuntarte al Imserso");
    }
  }